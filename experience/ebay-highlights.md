...
> Index and supplementary material for eBay experience notes. Individual STAR stories are in separate files below.

## Project Notes (STAR format)

- [[experience/eBay - DoJ and Jade Programs]] — compliance-driven infra migration, cross-functional war room, zero-downtime cutover
- [[experience/eBay - Global Team Expansion]] — built Europe & India teams from scratch, 8+ engineers hired in 3 months
- [[experience/eBay - AI Innovation]] — doubled PR output, 70% support automation, MCP server, spec-driven dev
