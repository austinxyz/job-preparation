...
###### Build Your Story Catalog

Story Builder walks you through this exact process — guided questions help you surface the right details, then AI structures them into interview-ready stories.
...
2. **Fill out the [story catalog worksheet](https://docs.google.com/spreadsheets/d/1KPfQLC46QDH0-GrbT-vUdprwXsPdHbxRzXa89y3y7v0/edit?usp=sharing)** for each core story. Capture Context, Actions, Results, Learnings, and Signal Areas. You're not writing a full interview answer. Just capture enough to remember what the story is and what signal it covers.
